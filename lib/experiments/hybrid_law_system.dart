  ...
  String answer(String urduQuestion) {
    ...
    try {
      ...
      switch (intent) {
        ...
        default:
          return _handleGeneralQuestion(urduQuestion);
      }
      
    } catch (e) {
      print('❌ Hybrid System Error: $e');
      return _formatError('جواب دینے میں مسئلہ', error: e.toString());
    }
  }
...
''';
      ...
      // ڈیفالٹ جواب بھی تفصیلی
      return _formatMathDefault(urduQuestion, e.toString());
    }
  }
...
''';
      ...
      return _formatError('کوانٹم سوال کا جواب دینے میں مسئلہ', error: e.toString());
    }
  }
  ...
  String _handlePhilosophicalQuestion(String urduQuestion) {
    ...
    try {
      print('🧩 LogicSolver سے کوشش کر رہا ہوں...');
...
''';
      ...
      return _formatPhilosophicalDefault(urduQuestion);
    }
  }
